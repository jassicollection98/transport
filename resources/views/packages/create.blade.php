...
<section>
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
            <form class="form-horizontal" id = "package-form" role="form" method="POST" action="{{ route('packages.save') }}" enctype="multipart/form-data">
                <div class="panel-heading">
                    <span style = "font-size:30px; font-weight:bold;">Create Package</span>
                ...
                <div class="panel-body">
                        ...
                        <div class = "row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name = "unique_code" class="form-control" id="unique_code">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name = "bill_date" class="form-control" id="bill_date">
                        ...
                        <div class = "row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name = "transport_company" class="form-control" id="transport_company">
                        ...
                        <div class = "row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "consignee_name" class="form-control" id="consignee_name">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "consignee_mobile" class="form-control" id="consignee_mobile">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="consignee_gst_no">GST NO:</label>
                                <input type="text" name = "consignee_gst_no" class="form-control" id="consignee_gst_no">
                        ...
                        <div class = "row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "consigner_name" class="form-control" id="consigner_name">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "consigner_mobile" class="form-control" id="consigner_mobile">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="consigner_gst_no">GST NO:</label>
                                <input type="text" name = "consigner_gst_no" class="form-control" id="consigner_gst_no">
                                ...
                                <div class = "row packets-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <div class="form-check" style = "margin: 5px 0;">
                                            ...
                                            <input type="radio" checked class="form-check-input" id="payment_status0" name="payment_status" value="1">
                                            <label class="form-check-label" for="payment_status0">Paid</label>
                                            <input type="radio" style = "margin-left:20px" class="form-check-input" id="payment_status1" name="payment_status" value="0">
                        ...
                        <div class = "row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "received_by" class="form-control" id="received_by">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "delivered_by" class="form-control" id="delivered_by">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name = "delivered_date" class="form-control" id="delivered_date">
                        ...
                        <div class = "row">
                            <div class="form-group col-md-12">
                                <button type="button" id = "save_package" name = "save_package" class="btn btn-primary">Create package</button>
                            </div>
                        </div>
